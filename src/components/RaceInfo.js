	...
	return (
		<div id="raceInfo">
			<div id="primaryRaceInfo" style={{ display: primaryStyle }}>
				...
				<p>{primaryInfo?.size_description}</p>
				<p>
				...
				<p>
					Choose {primaryInfo?.starting_proficiency_options?.choose}
				</p>
				<p>{primaryInfo?.starting_proficiency_options?.desc}</p>
				<span>
			...
			<div id="secondaryRaceInfo" style={{ display: secondaryStyle }}>
				...
				<p>{secondaryInfo?.size_description}</p>
				<p>
