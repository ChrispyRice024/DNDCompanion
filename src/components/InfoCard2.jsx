...
//   const getUrl = (desiredKey) => {
//     // if(desiredKey.includes('class')){
//       console.log('it includes class')
//     // }
//     // fetchData[desiredKey]
//   }
  
//   useEffect(() => {
//     getUrl('primary_class')
//   }, [fetchData])
//   useMemo(async() => {

//     // try{
//       const proChoices = fetchData.primary_class.proficiencies.map(item => item)
//       console.log(proChoices)
//     //   const res = await Promise.all(fetchData?.primary_class?.proficiencies?.proficiency_choices.map(item => fetch(`https://www.dnd5eapi.co${url.url}`)))
