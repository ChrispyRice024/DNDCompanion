          ...
          <div>
            ...
            <form>
                    ...
                    <div id='race_class'>
                        ...
                        <div>
                          ...
                          <div id='proInfo' style={{display:fetchData?.primary_class?.name ? '' : 'none'}}>
                              <ProInfo functions={{fetchData:fetchData,
                                                  setFetchData:setFetchData}} />
                          </div>
                          </div>
              ...
              <div>                    
                <div id='statsAndSuch'>
                  <div id='stats'>
                      <Stats functions={{fetchData:fetchData,
                                      setFetchData:setFetchData}} />
                  </div>
                  ...
                  <div id='combat'>
                      <Combat functions={{fetchData:fetchData,
                                          setFetchData:setFetchData}} />
                  </div>

                  <div id='skills'>
                      <Skills functions={{fetchData:fetchData,
                                          setFetchData:setFetchData}}/>
                  </div>
              ...
              : fetchData?.isCreatingNewChar === 'spellcasting' ?
                ...
                <div>
                    <div id='spellcasting'>
                      <Spellcasting functions={{fetchData:fetchData,
                                              setFetchData:setFetchData}} />
                    </div>
